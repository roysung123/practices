...
{ 
    ...
    private float aroundRadius = 1;//半徑
    ...
    void Start()
    {
        ...
        transform.localScale = new Vector3(Random.Range(0.4f,1f), Random.Range(0.4f, 1f), Random.Range(0.4f, 1f));
    ...
    void LateUpdate()
    {
        mspower = Vector3.Distance(new Vector3(0, 0, 0), GetComponent<Rigidbody>().velocity);
        //Debug.Log(mspower);
